package phrille.minecraftboom.lib;
...
public class Names
{
    ...
    //Bricks
    public static final String BLOCK_COBBLESTONE_BRICKS = "cobblestone_bricks";
    public static final String BLOCK_MOSSY_COBBLESTONE_BRICKS = "mossy_cobblestone_bricks";
    ...
    public static final String BLOCK_LIGHT_GRAY_TERRACOTTA_BRICKS = "light_gray_terracotta_bricks";
